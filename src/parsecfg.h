...
typedef enum { CFG_SIMPLE, CFG_INI } cfgFileType;
...
typedef enum { CFG_PARAMETER, CFG_VALUE, CFG_SECTION } cfgKeywordValue;

typedef enum { CFG_NO_QUOTE, CFG_SINGLE_QUOTE, CFG_DOUBLE_QUOTE } cfgQuote;
